...
public class ExchangeRateControllerTest {
    ...
    public  void returnRateResponseWhenRequestIsValidate() {
        ...
        when(exchangeRateService.saveRate(any())).thenReturn(Maybe.just(rateResponse));
        TestObserver<RateResponse> testObserver = exchangeRateController.saveRate(rateRequest).test();
        testObserver.awaitTerminalEvent();
        testObserver.assertComplete();
        testObserver.assertNoErrors();
        var actual = testObserver.values().get(0);
